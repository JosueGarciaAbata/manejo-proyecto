...
<div class="row row-cards">
    <div class="col-12">
        <form action="{{ route('admin.news.update-new',['id_new'=>Request('id_new')]) }}" method="post" id="editNewForm" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="ckeditor form-control" name="des_new" rows="6" placeholder="Contenido..."
                                    id="des_new">{!! $new->des_new !!}</textarea>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="image_holder mb-2" style="max-width: 250px">
                                ...
                                data-ijabo-default-img="{{ $new->resource_img_url }}">
                            </div>
                            <div class="mb-3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('form#editNewForm').on('submit', function(e) {
            e.preventDefault();
            toastr.remove();
            var form = this;
