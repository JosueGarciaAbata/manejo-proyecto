                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="input-icon mb-2 flex-grow-1">
                                        <input class="form-control" name="fec_ini_eve" placeholder="Seleccione una fecha" id="datepicker-icon-start" value="2020-06-20">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    <!-- Campo de fecha más amplio -->
                                    <div class="input-icon mb-2 flex-grow-1">
                                        <input class="form-control" name="fec_fin_eve" placeholder="Seleccione una fecha" id="datepicker-icon-end" value="2020-06-20">
                                        <span class="input-icon-addon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                                                <path stroke="none" d="M0 0h24V0H0z" fill="none"></path>
                                                <path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z"></path>
