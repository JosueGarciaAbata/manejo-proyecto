...
@section('content')
    <div class="row row-cards">
        <div class="col-12">
            <form action="{{ route('admin.proposals.update', ['id_pro' => $proposal->id_pro]) }}" method="post"
                id="edit-proposal" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tit_pro"
                                        value="{{ $proposal->tit_pro }}">
                                    <span class="text-danger error-text tit_pro_error"></span>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Descripción</label>
                                    <textarea class="ckeditor form-control" name="des_pro" rows="6" id="des_pro">
                                        {{ $proposal->des_pro }}
                                    </textarea>
                            ...
                            <div class="col-md-3">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="input-icon mb-2 flex-grow-1">
                                            <input class="form-control" name="fec_inc_pro"
                                                placeholder="Seleccione una fecha" id="datepicker-icon"
                                                value="{{ $proposal->fec_inc_pro }}">
                                ...
                                <div class="image_holder mb-2" style="max-width: 250px">
                                    <img src="" alt="" class="img-thumbnail" id="image-previewer"
                                        data-ijabo-default-img="{{ asset('storage/images/proposal_images/' . $proposal->img_pro) }}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="id_can" id="id_can">
                                        @foreach (\App\Models\Candidate::all() as $candidate)
                                            <option value="{{ $candidate->id_can }}"
                                                {{ $proposal->id_can == $candidate->id_can ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="checkbox" name="visible" id="visible" value="1"
                                        aria-describedby="visibleHelp" {{ $proposal->visible == 1 ? 'checked' : '' }}>
                                    <small id="visibleHelp" class="form-text text-muted">Marca esta casilla para que el
                                        contenido sea visible.</small>
                                </div>
                                <div class="mb-3">
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('form#edit-proposal').on('submit', function(e) {
                e.preventDefault();
                toastr.remove();
                const form = this;
