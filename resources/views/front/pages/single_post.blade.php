...
@section('meta_tags')
    ...
    <meta property="og:image"
        content="{{ route('storage_resize', $post->featured_image) }}">
        ...
        <div class="col-lg-8 mb-5 mb-lg-0">
            <article>
                <img loading="lazy" decoding="async"
                    src="{{ route('storage', $post->featured_image) }}" alt="Post Thumbnail"
                    class="w-100">
            ...
            <div class="mt-5">
                ...
                @if (Auth::check())
                    <script>
                        ...
                        (function() { // DON'T EDIT BELOW THIS LINE
                            ...
                            s.src = 'https://blog-php-owca.disqus.com/embed.js';
                ...
                @else
                    <h3 class="mb-1">Debes <a href="{{ route('author.login') }}">ingresar</a> para comentar!</h3>
                @endif
            </div>
        </div>
        <div class="col-lg-4">
    ...
    <script>
        $("body").floatingSocialShare({
            buttons: [
                ...
                "reddit", "telegram", "tumblr",
                "twitter", "viber", "whatsapp"
            ],
            text: "share with: ",
