<footer class="site-footer">
    <div class="site-footer__logo text-center">
        <a href="{{ url('/') }}"><img src="{{ asset('assets/images/logo-light.png') }}" alt=""
                width="174"></a>
                        ...
                        <ul class="list-unstyled footer-widget__posts-list">
                            <li>
                                <div class="footer-widget__posts-image">
                                    <img src="{{ asset('assets/images/resources/footer-post-1-1.png') }}"
                                        alt="">
                                </div><!-- /.footer-widget__posts-image -->
                                <div class="footer-widget__posts-content">
                                    <h4 class="footer-widget__posts-title"><a href="#">International
                                            conference</a></h4>
                            ...
                            <li>
                                <div class="footer-widget__posts-image">
                                    <img src="{{ asset('assets/images/resources/footer-post-1-2.png') }}"
                                        alt="">
                                </div><!-- /.footer-widget__posts-image -->
                                <div class="footer-widget__posts-content">
                                    <h4 class="footer-widget__posts-title"><a href="#">The strength of
                                            democracy</a></h4>
                                    <p class="footer-widget__posts-date">20 Oct, 2019</p>
                                    <!-- /.footer-widget__posts-date -->
                                </div><!-- /.footer-widget__posts-content -->
