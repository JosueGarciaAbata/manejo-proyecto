    ...
    <section class="event-details-box">
        <div class="container">
            <div class="row">
                        ...
                        <ul class="sidebar__tags-list">
                            @foreach (explode(',', $event->tag_eve) as $tag)
                                <li class="sidebar__tags-list-item"><a
                                        href="{{ route('events.searchByTag', ['tag' => trim($tag)]) }}">
                                        {{ trim($tag) }}
                                    </a></li>
                            @endforeach
                        </ul>
                ...
                <div class="col-lg-4 wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.8393469026173!2d-78.6260957147869!3d-1.2692740628827868!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91d38225e088295f%3A0xb16c26da66e6e4b3!2sUniversidad%20T%C3%A9cnica%20de%20Ambato!5e0!3m2!1ses-419!2sec!4v1729438296772!5m2!1ses-419!2sec"
                ...
                <div class="col-lg-4 wow fadeInRight animated same-height"
                    ...
                    <div class="event-details-box__single thm-base-bg-2">
                        ...
                        <ul class="list-unstyled event-details-box__list">
                            ...
                            <!-- Horario del evento -->
                            <li>{{ \Carbon\Carbon::parse($event->fec_ini_eve)->format('g:i a') }} -
                                {{ \Carbon\Carbon::parse($event->fec_fin_eve)->format('g:i a') }}</li>
                            <li>{{ $event->dir_eve }}</li>
                        </ul><!-- /.list-unstyled event-details-box__list -->
                    </div><!-- /.event-details-box__single -->
                </div><!-- /.col-lg-4 -->
